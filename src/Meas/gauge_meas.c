...
#pragma acc data present(quadri) present(loc_q)
	...
	double temp_ch;
	compute_local_topological_charge(u,quadri,loc_q,nnp_openacc,nnm_openacc,0,1);// (d0,d1) - (d2,d3)
	temp_ch = reduce_loc_top_charge(loc_q);
	compute_local_topological_charge(u,quadri,loc_q,nnp_openacc,nnm_openacc,0,2);// (d0,d2) - (d1,d3)
	temp_ch += reduce_loc_top_charge(loc_q);
	compute_local_topological_charge(u,quadri,loc_q,nnp_openacc,nnm_openacc,0,3);// (d0,d3) - (d1,d2)
	temp_ch += reduce_loc_top_charge(loc_q);
